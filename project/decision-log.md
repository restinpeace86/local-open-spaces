...
### Decision 014: 위치 미비 데이터 5대 카테고리 흡수 처리 및 기타 섹션 배제 (2026-08-25)
- **배경:** Decision 009의 '기타 섹션' 허용과 `ai-rule.md 4.1`의 'ETC 강제 금지' 상충 해소.
- **결정 사항:** 
  1. 위치 정보 미비 데이터는 '기타' 섹션으로 배제하지 않고, 표준 5대 카테고리 중 가장 적합한 카테고리로 강제 흡수 분류한다.
  2. Decision 009의 '기타 섹션' 승인 건은 본 Decision 015로 대체 및 폐지한다.
