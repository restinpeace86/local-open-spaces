...
export const CATEGORY_MAJ_OPTIONS: CategoryMajOption[] = [
  // [todo.md 개선사항 4 되돌림](2026-09-19 사용자 지시): 이 목록의 '캠핑장'/'키즈카페'/
  // '체험휴양마을'/'교육농장'/'체험학습장'은 get-home-feed.ts가 한때 open_spaces 원본을
  // item_type='EVENT'로 바꿔치기해 이벤트픽에 섞어 보여주던 대상이었다
  // (SHARED_OPEN_SPACES_CATEGORY_MINS, 2026-09-03~05). 그 주입 로직은 삭제됐고 이제
  // 이벤트픽은 진짜 events 행만 보여준다 — 이 5개는 실제 이벤트가 거의 없어 개선사항3의
