    ...
    <div className="fixed inset-0 bg-black/40 z-50 flex items-end md:items-center justify-center" {...backdropDismiss}>
      ...
      >
        <div className="p-5">
          ...
          {table !== 'raw_ingest_data' && table !== 'curated_items' && table !== 'spot_curations' && table !== 'mom_pick_posts' && table !== 'mom_pick_unmapped_spots' && table !== 'spot_dedup' && table !== 'category_mapping' && table !== 'myrealtrip_search' && table !== 'spot_notices' && onCategoryMinUpdated && (
            <CategoryMinEditor
              table={table}
