...
// Task 9-1-4: 레거시 카테고리 표기 제거 후 5대 UI 카테고리(UI_CATEGORY_FILTER_OPTIONS)만 남아
// 기본값도 이것 하나뿐이다. options를 지정하면 표시할 카테고리를 제한할 수 있다.
export function CategoryFilter({
  value,
  onChange,
  options = UI_CATEGORY_FILTER_OPTIONS,
}: {
  value: string;
  onChange: (category: string) => void;
  options?: typeof UI_CATEGORY_FILTER_OPTIONS;
}) {
  return (
