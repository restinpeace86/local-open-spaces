...
// 끝나는 게 이상하다는 지적 — Hero Carousel의 "오늘 전체보기"(/events/today)와 동일한
// 패턴으로, 실제 DB 페이지네이션을 갖춘 전용 화면을 둔다.
export default function ReservationOpenEventsPage() {
  ...
  useEffect(() => {
    ...
    fetch(`/api/events/reservation-open?page=${page}&page_size=${PAGE_SIZE}`)
      .then((res) => res.json())
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      <div className="shrink-0 p-4 border-b border-gray-100 flex items-center justify-between">
        ...
        <span className="text-base font-bold text-gray-900">📋 예약 가능 전체보기</span>
